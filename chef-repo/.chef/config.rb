...
current_dir                  = File.dirname(__FILE__)
  ...
  validation_client_name     'mintyross-validator' # "#{ENV['ORGNAME']}-validator"
  validation_key             "#{current_dir}/mintyross-validator.pem" # from Chef.io
  data_bag_encrypt_version   2
  encrypted_data_bag_secret  "#{current_dir}/encrypted_data_bag_secret"
  trusted_certs_dir          "#{current_dir}/trusted_certs"
  chef_server_url            "https://chef.mintyross.com/organizations/mintyross"
